...
const features = [
  ...
  {
    svgPath: "M208 128l-80 80M192 40L40 192",
    title: "ShadeCN UI",
    description: 
      "UI components built with ShadeCN UI",
      fillRule: "inherit",
  }
  // {
  //   svgPath:
    ...
    <>
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          ...
          <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
            A web dashboard with Next.js 14 and Supabase.
          </p>
      ...
      >
        <div className="mx-auto flex max-w-[58rem] flex-col items-center space-y-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            A modern app, with features like Supabase Auth, API routes, and static pages in
            Next.js 14.
          </p>
        </div>
      ...
      <section id="open-source" className="container py-8 md:py-12 lg:py-24">
        <div className="mx-auto flex max-w-[58rem] flex-col items-center justify-center gap-4 text-center">
          ...
          <p className="max-w-[85%] leading-normal text-muted-foreground sm:text-lg sm:leading-7">
            Proof of Concept Dashboard Demo for Taxi Management System. <br />{" "}
